...
<template>
  <SidebarProvider>
    ...
    <SidebarInset>
      <header class="flex h-16 w-full shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
        <div class="flex w-full items-center gap-2 px-4">
          <SidebarTrigger class="-ml-1" />
          <Separator orientation="vertical" class="mr-2 h-4" />
          <Placeholder class="h-6 w-64" />
          <Placeholder class="ml-auto h-6 w-8" />
          <Placeholder class="h-6 w-8" />
        </div>
      </header>
      <main class="flex flex-1 flex-col gap-4 p-4 pt-0">
        ...
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
          <Placeholder v-for="i in 3" :key="i" class="aspect-video rounded-xl" />
        </div>
        <div class="grid auto-rows-min gap-4 md:grid-cols-2">
          <Placeholder v-for="i in 2" :key="i" class="aspect-video rounded-xl" />
        </div>
        <Placeholder class="min-h-screen flex-1 rounded-xl md:min-h-min" />
      </main>
    </SidebarInset>
  </SidebarProvider>
</template>
