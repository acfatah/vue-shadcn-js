...
The color tokens are defined in `src/style/app.css` using hsl format.
You can use [scadcn customizer](https://customizer.railly.dev) to generate style.

By default, all [Tailwindcss Colors](https://tailwindcss.com/docs/customizing-colors)
are available.
You may also use [this tool](https://redpixelthemes.com/blog/tailwindcss-colors-different-formats/)
to get hsl value from Tailwindcss colors.
