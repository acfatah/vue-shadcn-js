          ...
          <SidebarMenuItem>
            <DropdownMenu>
              ...
              >
                ...
                >
                  v{{ version }}
                  <CheckIcon v-if="version === selectedVersion" class="ml-auto" />
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </SidebarMenuItem>
          ...
          <SidebarGroup class="py-0">
            <SidebarGroupContent class="relative">
              ...
              <SidebarInput
                ...
                class="pl-8"
              />
              <SearchIcon class="pointer-events-none absolute left-2 top-1/2 size-4 -translate-y-1/2 select-none opacity-50" />
            </SidebarGroupContent>
          </SidebarGroup>
        </form>
      </SidebarHeader>
